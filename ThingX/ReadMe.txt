========================================================================
    ACTIVE TEMPLATE LIBRARY : ThingX Project Overview
========================================================================

AppWizard has created this ThingX project for you to use as the starting point for
...
ThingX.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ThingX.h)
        GUID definitions                                (ThingX_i.c)
        A type library                                  (ThingX.tlb)
        Marshaling code                                 (ThingX_p.c and dlldata.c)

ThingX.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ThingX.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ThingX.pch and a precompiled types file named StdAfx.obj.
...
ThingXps.vcxproj
	...
	dlldata.c, ThingX_i.c and ThingX_p.c which are required
	to build the proxy/stub DLL.

ThingXps.vcxproj.filters
